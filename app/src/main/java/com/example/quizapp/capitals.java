...
public class capitals extends SQLiteOpenHelper {
    ...
    private static final String Database_path = "/data/data/com.example.quizapp/databases/";
    ...
    {
        String Ans = "all";//string that contains the required field  note that Ans is just a local string not related to Answer or Option...
        Cursor c = sqlite.rawQuery("SELECT " + Question + " FROM " + Table_name + " WHERE " + uid + " = " + 1 + "", null);//cursor to that query
        if (c.moveToFirst())
            Ans = c.getString(0);
        else
            Ans = "all";
    ...
    {
        String Ans = "all";//string that contains the required field  note that Ans is just a local string not related to Answer or Option...
        Cursor c = sqlite.rawQuery("SELECT " + OptionA + " FROM " + Table_name + " WHERE " + uid + " = " + 1 + "", null);//cursor to that query
        if (c.moveToFirst())
            Ans = c.getString(0);
        else
            Ans = "all";
    ...
    {
        String Ans = "jhgfkyj";//string that contains the required field  note that Ans is just a local string not related to Answer or Option...
        Cursor c = sqlite.rawQuery("SELECT " + OptionB + " FROM " + Table_name + " WHERE " + uid + " = " + 1 + "", null);//cursor to that query
        if (c.moveToFirst())
            Ans = c.getString(0);
        else
            Ans = "";
    ...
    {
        String Ans = "hgfjg";//string that contains the required field  note that Ans is just a local string not related to Answer or Option...
        Cursor c = sqlite.rawQuery("SELECT " + OptionC + " FROM " + Table_name + " WHERE " + uid + " = " + 1 + "", null);//cursor to that query
        if (c.moveToFirst())
            Ans = c.getString(0);
        else
            Ans = "";
    ...
    {
        String Ans = "hjtfdjth";//string that contains the required field  note that Ans is just a local string not related to Answer or Option...
        Cursor c = sqlite.rawQuery("SELECT " + OptionD + " FROM " + Table_name + " WHERE " + uid + " = " + 1 + "", null);//cursor to that query
        if (c.moveToFirst())
            Ans = c.getString(0);
        else
            Ans = "";
    ...
    public String readAnswer(int i)//Used to read the data from the Des.db file where id is given and we choose id randomly
    {
        ...
        String Ans = "all";//string that contains the required field
        Cursor c = sqlite.rawQuery("SELECT " + Answer + " FROM " + Table_name + " WHERE " + uid + " = " + 1 + "", null);//cursor to that query
        if (c.moveToFirst())
            Ans = c.getString(0);
        else
            Ans = "all";
